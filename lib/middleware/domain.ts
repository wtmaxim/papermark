...
export default async function DomainMiddleware(req: NextRequest) {
  ...
  // If it's the root path, redirect to paperky.com/home
  if (path === "/") {
    ...
    return NextResponse.redirect(
      new URL("https://www.paperky.com/home", req.url),
    );
  }
  ...
  return NextResponse.rewrite(url, {
    headers: {
      ...
      "X-Powered-By":
        "Paperky.com - Document sharing infrastructure for the modern web",
    },
  });
}
