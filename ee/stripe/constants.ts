...
export const BASE_FEATURES: Record<PlanEnum, PlanFeatures> = {
  [PlanEnum.Pro]: {
    ...
    features: [
      ...
      { id: "branding", text: "Remove Getpixcel branding" },
  ...
  [PlanEnum.Business]: {
    ...
    features: [
      ...
      { id: "screen-shield", text: "Screen shield/fence protection" },
  ...
  [PlanEnum.DataRoomsPlus]: {
    ...
    features: [
      ...
      { id: "invite", text: "Email invite viewers directly from Getpixcel" },
      { id: "white-label", text: "White-labeling" },
