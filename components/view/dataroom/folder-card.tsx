...
export default function FolderCard({
  ...
  return (
    <div className="group/row relative flex items-center justify-between rounded-lg border-0 p-3 ring-1 ring-gray-400 transition-all hover:bg-secondary hover:ring-gray-500 dark:bg-secondary dark:ring-gray-500 dark:hover:ring-gray-400 sm:p-4">
