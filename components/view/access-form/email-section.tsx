  ...
  return (
    <div className="relative space-y-2">
      ...
      <input
        ...
        translate="no"
        className={cn(
          "notranslate flex w-full rounded-md border-0 bg-black py-1.5 text-gray-500 shadow-xs ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-300 sm:text-sm sm:leading-6",
