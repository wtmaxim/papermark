...
export default function DomainSection({
  ...
  const [displayValue, setDisplayValue] = useState<string>("paperky.com");
  ...
  const isEditingCustomDomain =
    editLink && data.domain && data.domain !== "paperky.com" ? true : false;
  ...
  const handleDomainChange = (value: string) => {
    ...
    if (isEditingCustomDomain && !canChangeCustomDomain) {
      setDisplayValue(data.domain ?? "paperky.com");
      return;
    }
    ...
    if (value === "add_domain" || value === "add_dataroom_domain") {
      setModalOpen(true);
      setData({ ...data, domain: "paperky.com" });
      setDisplayValue("paperky.com");
      return;
    }

    // Check if this is a custom domain selection (not paperky.com)
    if (value !== "paperky.com") {
  ...
  useEffect(() => {
    if (domains && !editLink) {
      ...
      const domainValue = canUseCustomDomain
        ? (defaultDomain?.slug ?? "paperky.com")
        : "paperky.com";
  ...
  const defaultDomain = editLink
    ? (data.domain ?? "paperky.com")
    : (linkType === "DOCUMENT_LINK" && canUseCustomDomainForDocument) ||
        (linkType === "DATAROOM_LINK" && canUseCustomDomainForDataroom)
      ? (domains?.find((domain) => domain.isDefault)?.slug ?? "paperky.com")
      : "paperky.com";
  ...
  return (
    <>
        ...
        {data.domain && data.domain !== "paperky.com" ? (
          <Input
            ...
            className={cn(
              ...
              data.domain && data.domain !== "paperky.com" ? "flex" : "",
      ...
      {data.domain && data.domain !== "paperky.com" && !isDomainVerified ? (
