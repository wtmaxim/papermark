        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              your Paperky account has been invalid for 30 days. As a result,
              it has been deleted from Paperky.
            </Text>
            <Text className="text-sm leading-6 text-black">
              If you would like to restore the domain, you can easily create it
              again on Paperky with the link below.
            </Text>
            ...
            <Text className="text-sm leading-6 text-black">
              If you did not want to keep using this domain on Paperky anyway,
