        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              your Getpixcel account has been invalid for 30 days. As a result,
              it has been deleted from Getpixcel.
            </Text>
            <Text className="text-sm leading-6 text-black">
              If you would like to restore the domain, you can easily create it
              again on Getpixcel with the link below.
            </Text>
            <Section className="my-8 text-center">
              <Button
                className="rounded bg-black text-center text-xs font-semibold text-white no-underline"
                href={`https://app.getpixcel.com/settings/domains`}
            ...
            <Text className="text-sm leading-6 text-black">
              If you did not want to keep using this domain on Getpixcel anyway,
